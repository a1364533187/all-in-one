...
public class KthSmallestInLexicographicalOrder440Solution {
    ...
    public static void main(String[] args) {
        System.out.println(findKthNumber(200, 101));
    }

    // prefix是前缀，n是上界
    private static long GetPrefixCount(long prefix, long n) {
        long cur = prefix;
